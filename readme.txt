...
3. When the popup appears select the the-events-calendar-generator.x.x.zip file from your desktop. (The 'x.x' will change depending on the current version number).
...
* <a href="http://m.tri.be/18l-">New User Primer: Event Generator</a>
* <a href="http://m.tri.be/18m1">Configuring Event Generator</a>
* <a href="http://m.tri.be/18m0">Event Generator: Tracking sales & getting paid</a>
...
First, make sure that you're running the latest version of The Events Calendar, Event Generator, Event Tickets, and Tickets Plus. If you've got any other add-ons, make sure those are current / running the latest code as well.
...
* <a href="http://m.tri.be/18m2" target="_blank">The Events Calendar: Event Generator</a>
...
* Include Rotate command for events.
